 ...
 *
 * Rated describes a nested schema, and the sink writes CSV. A Dataset
...
object Ds2BadModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder().master("local[*]").appName("Ds2BadModel").getOrCreate()
    ...
    Sink.ofDataset(d6, Sink.scratch(spark, "Ds2BadModel"))
